...
class ZvolvClient:
    ...
    def auth(self):
        ...
        if not self._auth_module:
            self._auth_module = Auth(self.session, self.logger, self.base_url,
                                     self._workspace_module.workspace_instance)
    ...
    def usergroups(self):
        ...
        if not self._usergroups_module:
            self._usergroups_module = UserGroups(self.session, self.logger, self.base_url,
                                                 self._workspace_module.workspace_instance)
    ...
    def files(self):
        ...
        if not self._files_module:
            self._files_module = Files(self.session, self.logger, self.base_url,
                                       self._workspace_module.workspace_instance)
